...
metrics.write_td_evaluation("overworld_sample_set_td.txt" ,model1name, "Overworld Train Set Evaluation:", metrics.evaluate_tonal_distance(data_set1= val_set_model2, thresh= thresh))
